package org.rjo.chess.bulldog.board;
...
public enum Ray {
   ...
   public static final Ray[] RAY_TYPES_HORIZONTAL_VERTICAL = { Ray.NORTH, Ray.WEST, Ray.SOUTH, Ray.EAST };
    ...
    */
   public static final long[][] bitmaskBetweenSquares;

   public static final long fullysetBsAsLong = -1L;
   ...
   static {
      ...
      // 0 == top-left
      BitSetUnifier[][] tmpBitmaskBetweenSquares = new BitSetUnifier[64][64];
      bitmaskBetweenSquares = new long[64][64];
      for (int sq = 0; sq < 64; sq++) {
         for (int targetSq = 0; targetSq < 64; targetSq++) {
            ...
            tmpBitmaskBetweenSquares[sq][targetSq] = bs;
            bitmaskBetweenSquares[sq][targetSq] = tmpBitmaskBetweenSquares[sq][targetSq].toLongArray()[0];
         }
      }
   }
