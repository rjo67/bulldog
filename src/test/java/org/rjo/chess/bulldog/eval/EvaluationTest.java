...
public class EvaluationTest {
	...
	@Test
	public void posnScore() {
		Position p = Fen.decode("rnb1k1nr/pppp1ppp/8/3P2q1/8/2N5/PP1QPPPP/R3KBNR w KQkq - 2 7").getPosition();
		var initialScore = p.evaluate();
		// after white takes black queen d2xg5
		p = Fen.decode("rnb1k1nr/pppp1ppp/8/3P2Q1/8/2N5/PP2PPPP/R3KBNR b KQkq - 2 7").getPosition();
		var newScore = p.evaluate();

		System.out.println("Initial score: " + initialScore + ", after taking queen: " + newScore);
	}
